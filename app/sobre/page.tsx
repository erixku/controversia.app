...
export default function ProjectOverview() {
  return (
    <div className="flex-grow px-4 sm:px-6 pt-24 md:px-20 md:pt-32 max-w-5xl mx-auto w-full">
      <header className="mb-16 border-b border-neutral-800 pb-8">
        <h1 className="text-3xl sm:text-5xl md:text-7xl font-display font-bold mb-4">ESPECIFICAÇÃO DO PROJETO</h1>
        <p className="text-base sm:text-xl font-serif italic text-neutral-400">
          Entendimento técnico e arquitetural da plataforma "Controversia".
        </p>
      </header>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 font-serif leading-relaxed text-base sm:text-lg text-neutral-300">
        <section>
          <h3 className="font-display text-2xl text-white mb-6 uppercase tracking-wider border-l-4 border-white pl-4">Objetivo Central</h3>
          <p className="mb-4">Desenvolver uma aplicação web de jogo de cartas multijogador em tempo real, suportando até 15 jogadores simultâneos por sala. A mecânica se baseia na associação satírica de frases (Cards Against Humanity / F.D.P.), exigindo baixa latência e sincronização de estado perfeita entre clientes.</p>
          <p>O diferencial reside na estética <strong>minimalista e ousada</strong> (Preto e Branco), focando na tipografia e no contraste para criar uma experiência imersiva e madura.</p>
        </section>

        <section>
          <h3 className="font-display text-2xl text-white mb-6 uppercase tracking-wider border-l-4 border-white pl-4">Arquitetura Tecnológica</h3>
        ...
        <section className="md:col-span-2 mt-8">
            <h3 className="font-display text-2xl text-white mb-6 uppercase tracking-wider border-l-4 border-white pl-4">Funcionalidades de Destaque Planejadas</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="border border-neutral-800 p-4 sm:p-6 hover:border-white transition-colors duration-300">
